  ...
  return (
    <BaseLayout source={bgImage} >
          <View className="mt-10 mx-5">
            ...
            <Text className="text-xs text-[#fff] my-5 leading-6">{textindent}为了给您提供更好的服务，请您通过人脸识别来完成性别认证。您上传的照片仅用于性别认证，我们不会留存。</Text>
            <Text className="text-xs text-[#fff] leading-6">{textindent}点击同意则表示您同意我们根据以上方式和目的使用您提供的本人照片收集您的性别信息。</Text>
          </View>
