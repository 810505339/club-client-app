...
const renderItem = ({ item }) => {
  return (<List.Item title={item.title} right={props => <List.Icon {...props} icon="chevron-right" />} />);
};
...
const ListHeader = () => {
  ...
  return <View className=" rounded-t-3xl">
    ...
    <View className="flex flex-row  gap-3  border-dashed border-b border-[#ffffff7f] pb-4 px-5">
